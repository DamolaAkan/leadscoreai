...
export async function POST(request: Request) {
  try {
    ...
    // the shared event_id (resp.id). Awaited so it completes before the function
    // returns; never throws (helper swallows errors).
    ...
    await sendMetaLead({
      ...
      funnel: "solar",
      eventSourceUrl: sig.eventSourceUrl || "https://app.leadscoreai.com/solar",
